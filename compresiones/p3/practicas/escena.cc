...
void Escena::init_objetos()
{
   ...
   flecha = new Flecha3D(75, 50);
   ejesFlecha = new EjesFlechas();
...
void Escena::init_luces()
{
   ...
   luzPos = new LuzPosicional({0,100,100}, GL_LIGHT1, {0.5,0.5,0.5,1}, {0.6,0.6,0.6,1}, {1,1,1,1});
...
void Escena::draw_objects()
{
   ...
   if (puntos or alambre or solido){
      if (obj == CUBO){
         ...
         cubo->draw(puntos, false, false, 0);
         cubo->draw(false, alambre, false, 0);
         cubo->draw(false, false, solido, 0);
      }

      if (obj == FLECHA){
         flecha->draw(puntos, false, false, 0);
         flecha->draw(false, alambre, false, 0);
         flecha->draw(false, false, solido, 0);
      }
         
      else if (obj == PIRAMIDE){
         piramide->setMaterial(matBlanco);
         piramide->draw(puntos, false, false, 0);
         piramide->draw(false, alambre, false, 0);
         piramide->draw(false, false, solido, 0);
      }
         ...
         if (objPlySel == PLY1){
            ...
            ply1->draw(puntos, false, false, 0);
            ply1->draw(false, alambre, false, 0);
            ply1->draw(false, false, solido, 0);
         }
            ...
            ply1->setMaterial(matBlanco);
            ply2->draw(puntos, false, false, 0);
            ply2->draw(false, alambre, false, 0);
            ply2->draw(false, false, solido, 0);
         }
            ...
            ply3->draw(puntos, false, false, 0);
            ply3->draw(false, alambre, false, 0);
            ply3->draw(false, false, solido, 0);
         }
      }

      else if (obj == CILINDRO){
         cilindro->setMaterial(bronce);
         cilindro->draw(puntos, false, false, 0);
         cilindro->draw(false, alambre, false, 0);
         cilindro->draw(false, false, solido, 0);
      }

      else if (obj == ESFERA){
         esfera->setMaterial(matBlanco);
         esfera->draw(puntos, false, false, 0);
         esfera->draw(false, alambre, false, 0);
         esfera->draw(false, false, solido, 0);
      }

      else if (obj == CONO){
         cono->setMaterial(matBlanco);
         cono->draw(puntos, false, false, 0);
         cono->draw(false, alambre, false, 0);
         cono->draw(false, false, solido, 0);
      }
         ...
         rev->draw(puntos, false, false, 0);
         rev->draw(false, alambre, false, 0);
         rev->draw(false, false, solido, 0);
...
void Escena::draw_axis()
{
   ...
   ejesFlecha->draw(puntos, alambre, solido, 0);
}
...
bool Escena::teclaPulsada( unsigned char tecla, int x, int y )
{
   ...
   switch( toupper(tecla) )
   {
      ...
      case 'O':
         if (modoMenu == NADA){
            cout << "\nSELECCIÓN DE OBJETO (OPCIONES C, F, P, Y, E, R, N, M, 4, Q)" << endl;
            modoMenu = SELOBJETO; 
         }
