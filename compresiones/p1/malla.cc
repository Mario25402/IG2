...
void Malla3D::draw(bool puntos, bool alambre, bool solido, bool cubo)
{
   // Modo de visualización //

   setColor(puntos, alambre, solido, cubo);
...
void Malla3D::setColor(bool puntos, bool alambre, bool solido, bool cubo)
{
