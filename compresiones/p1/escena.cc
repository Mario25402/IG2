...
void Escena::dibujar()
{
   ...
   if (puntos or alambre or solido){
      if (obj == CUBO){
         cubo->draw(puntos, false, false, true);
         cubo->draw(false, alambre, false, true);
         cubo->draw(false, false, solido, true);
      }
         
      else if (obj == PIRAMIDE){
         piramide->draw(puntos, false, false, false);
         piramide->draw(false, alambre, false, false);
         piramide->draw(false, false, solido, false);
      }
   }
}
